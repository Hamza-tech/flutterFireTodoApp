...
class _SignUp_ScreenState extends State<SignUp_Screen> {
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                SizedBox(height: 10),
                textfield(passwordConfirm, _focusNode3, 'Confirm Password', Icons.password, _isPasswordConfirmVisible, () {
                setState(() {
    ...
    return Padding(
      ...
      child: GestureDetector(
        onTap: () async {
          ...
          //     MaterialPageRoute(builder: (context) => LogIn_Screen(widget.show)),
          //   );
          // } else {
          //   // Handle registration failure (e.g., show a dialog or a snackbar)
  ...
  Widget textfield(TextEditingController controller, FocusNode focusNode,
      String typeName, IconData iconss, [bool isPasswordVisible = false, VoidCallback? togglePasswordVisibility]) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 15),
      child: Container(
        decoration: BoxDecoration(
